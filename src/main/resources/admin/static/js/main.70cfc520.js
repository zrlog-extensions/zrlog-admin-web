...
`;var s=r(9950),l=r(33730),d=r(44414);const c=e=>{let{htmlContent:t,previewRef:r,editable:n,onContentChange:c,style:g}=e;const h=(0,s.useRef)(null);(0,s.useEffect)(()=>{h.current&&h.current.innerHTML!==t&&(h.current.innerHTML=t)},[t]);const A={ref:h,autoFocus:!1,contentEditable:n,className:"markdown-body",onInput:()=>{c&&h.current&&c(h.current.innerHTML)},style:{outline:"none",boxShadow:"none"}};return(0,d.jsx)(l.Q,{ref:r,style:g,children:o.Ay.isDarkMode()?(0,d.jsx)(a,{...A}):(0,d.jsx)(i,{...A})})}},31743:(e,t,r)=>{r.d(t,{A:()=>d});var o=r(9950),n=r(28429),a=r(85221),i=r(37596),s=r(35434),l=r(44414);const d=e=>{let{children:t}=e;const r=(0,n.zy)(),d=(0,n.Zp)(),c="true"===sessionStorage.getItem("loaded")||!(0,s.xx)(),[g,h]=(0,o.useState)(c);return(0,o.useEffect)(()=>{if(g)return;const e=(0,a.HB)();return sessionStorage.setItem("loaded","true"),e&&e!==(0,i.dy)(r)?(console.log((0,i.dy)(r)+" redirecting to last opened page:",e),void d(e)):void 0},[]),(0,o.useEffect)(()=>{if(!(0,s.xx)())return;const e=(0,i.dy)(r);if(!g){const t=(0,a.HB)();return void((void 0===t||null===t||t===e)&&h(!0))}"true"===sessionStorage.getItem("loaded")&&(e.startsWith("/500")||e.startsWith("/404")||e.startsWith("/403")||e.startsWith("/offline")||(0,a.cw)(e))},[r]),g?(0,l.jsx)(l.Fragment,{children:t}):(0,l.jsx)(l.Fragment,{})}},33730:(e,t,r)=>{r.d(t,{Q:()=>o});const o=(0,r(24937).Ay)("div")`
